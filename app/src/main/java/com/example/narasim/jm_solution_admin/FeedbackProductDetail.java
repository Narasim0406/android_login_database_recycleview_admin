...
public class FeedbackProductDetail extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_feedback_product_detail);
    ...
    private void getEmployee(){
        class GetEmployee extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(FeedbackProductDetail.this,"Fetching...","Wait...",false,false);
            }
...
//        final String reply = editTextReply.getText().toString().trim();
        ...
        class UpdateEmployee extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(FeedbackProductDetail.this,"Updating...","Wait...",false,false);
            }
            ...
            protected void onPostExecute(String s) {
                super.onPostExecute(s);
                loading.dismiss();
                Toast.makeText(FeedbackProductDetail.this,s, Toast.LENGTH_LONG).show();
            }
...
//                hashMap.put(Config.KEY_EMP_REPLY,reply);
                ...
                String s = rh.sendPostRequest(Config.URL_UPDATE_PRODUCT_REPLY,hashMap);
        ...
        alertDialogBuilder.setPositiveButton("Yes",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        deleteEmployee();
                        startActivity(new Intent(FeedbackProductDetail.this,FeedbackProduct.class));
                    }
                });
