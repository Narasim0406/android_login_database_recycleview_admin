...
public class FeedbackServiceDetail extends AppCompatActivity implements View.OnClickListener {

    private EditText editTextId;
    private EditText editTextName, editTextFeed, editTextReply;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_feedback_service_detail);
    ...
    private void getEmployee(){
        class GetEmployee extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(FeedbackServiceDetail.this,"Fetching...","Wait...",false,false);
            }
...
//            String reply = c.getString(Config.TAG_REPLY);
...
//        final String mobile = editTextMobile.getText().toString().trim();
        final String status = editTextReply.getText().toString().trim();
...
//        final String reply = editTextReply.getText().toString().trim();
        ...
        if (TextUtils.isEmpty(status) || status.length() < 60) {
            editTextReply.setError("Please enter min 60 char");
        ...
        class UpdateEmployee extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(FeedbackServiceDetail.this,"Updating...","Wait...",false,false);
            }
            ...
            protected void onPostExecute(String s) {
                super.onPostExecute(s);
                loading.dismiss();
                Toast.makeText(FeedbackServiceDetail.this,s, Toast.LENGTH_LONG).show();
            }
...
//                hashMap.put(Config.KEY_EMP_REPLY,reply);
                ...
                String s = rh.sendPostRequest(Config.URL_UPDATE_SERVICE_REPLY,hashMap);
        ...
        alertDialogBuilder.setPositiveButton("Yes",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        deleteEmployee();
                        startActivity(new Intent(FeedbackServiceDetail.this, ReportService.class));
                    }
                });
