...
public class FeedbackService extends AppCompatActivity implements ListView.OnItemClickListener {
...
//        textUsername.setText(user.getUsername());
    ...
    private void showEmployee(){
        ...
        ListAdapter adapter = new SimpleAdapter(
                FeedbackService.this, list, R.layout.list_feedback_service,
...
//        String username = textUsername.getText().toString();
        final String URL_PRODUCTS = "http://arunraaza.com/android/android/admin/getServiceFeed.php";
        ...
        class GetJSON extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(FeedbackService.this,"Fetching Data","Wait...",false,false);
            }
...
//                String username = textUsername.getText().toString();
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        Intent intent = new Intent(this, FeedbackServiceDetail.class);
